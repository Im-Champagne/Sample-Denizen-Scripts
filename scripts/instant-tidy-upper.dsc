  ...
  events:
    ...
    on player breaks block:
      ...
      - if <context.block.material.name> == SHULKER_BOX && <player.is_sneaking>:
        ...
        # 1. Cancel the block break event so the box stays put with its new contents.
        - determine passively cancelled

        # 2. Store the player's main inventory contents (slots 10 through 36)
        ...
        # 3. Store the shulker box's full inventory contents from it's location
        ...
        # 5. Give the player a little sparkle of feedback!
